            ...
            <AnimatePresence>
                ...
                {isOpen &&
                    ...
                    >
                        ...
                        >
                            <h5
                                className="your-reserve__title semiBold"
                            >
                                L{reserves.length > 1 ? 'e' : 'a'} tu{reserves.length > 1 ? 'e' : 'a'} prenotazion{reserves.length > 1 ? 'i' : 'e'}
                            </h5>
                            <div className="your-reserve__label--container">
                                <p
                                    className="your-reserve__label--room select__label label"
                                >Stanza</p>
                                <p
                                    className="your-reserve__label--time select__label label"
                                >Orario</p>
                            </div>
